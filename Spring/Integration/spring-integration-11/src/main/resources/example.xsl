...
<xsl:stylesheet
        ...
        xsi:schemaLocation="http://spring-integration.javacourse.edu ">
    ...
    <xsl:template match="javacourse:application">
        <html>
            ...
            <body>
                ...
                <h1>Hello <xsl:value-of select="javacourse:name/text()"/>, your age is
                ...
                <h3>You
                    <xsl:value-of select="$permission"/> drink C2H5OH
                </h3>
            </body>
        </html>
    </xsl:template>
