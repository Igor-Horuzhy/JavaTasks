...
import edu.gemini.database.students.logic1.Group;
import edu.gemini.database.students.logic.ManagementSystem;
import edu.gemini.database.students.logic1.Student;

public class StudentsFrame extends JFrame {

    edu.gemini.database.students.logic1.ManagementSystem ms = null;
    ...
    public StudentsFrame() throws Exception {
        ...
        ms =  edu.gemini.database.students.logic1.ManagementSystem.getInstance();
